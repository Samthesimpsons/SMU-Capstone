...
In addition to the Buy transactions and risk-band fields described in Sections~\ref{sec:intro} and~\ref{sec:method}, FAR-Trans~\cite{sanzcruzado:fartrans} provides 159{,}136 Sell transactions and daily closing prices spanning January 2018 to November 2022. Of the 29{,}090 retail customers, 28{,}770 (99.0\%) carry a declared or regression-imputed MiFID risk band; the remaining 320 are excluded from all coherence computations. Customer profiles also include \texttt{customerType} and \texttt{investmentCapacity}, both of which enter the RQ2 regression controls in Section~\ref{sec:setup:stats}.
